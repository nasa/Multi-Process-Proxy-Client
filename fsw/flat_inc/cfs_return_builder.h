...
static const flatbuffers_voffset_t __cFS_Return_UnInteger16_required[] = { 0 };
typedef flatbuffers_ref_t cFS_Return_UnInteger16_ref_t;
static cFS_Return_UnInteger16_ref_t cFS_Return_UnInteger16_clone(flatbuffers_builder_t *B, cFS_Return_UnInteger16_table_t t);
__flatbuffers_build_table(flatbuffers_, cFS_Return_UnInteger16, 1)
...
#define __cFS_Return_UnInteger16_formal_args , uint16_t v0
#define __cFS_Return_UnInteger16_call_args , v0
static inline cFS_Return_UnInteger16_ref_t cFS_Return_UnInteger16_create(flatbuffers_builder_t *B __cFS_Return_UnInteger16_formal_args);
__flatbuffers_build_table_prolog(flatbuffers_, cFS_Return_UnInteger16, cFS_Return_UnInteger16_identifier, cFS_Return_UnInteger16_type_identifier)
...
static inline cFS_Return_FuncReturn_union_ref_t cFS_Return_FuncReturn_as_UnInteger16(cFS_Return_UnInteger16_ref_t ref)
{ cFS_Return_FuncReturn_union_ref_t uref; uref.type = cFS_Return_FuncReturn_UnInteger16; uref.value = ref; return uref; }
...
static cFS_Return_FuncReturn_union_ref_t cFS_Return_FuncReturn_clone(flatbuffers_builder_t *B, cFS_Return_FuncReturn_union_t u)
{
    ...
    case 2: return cFS_Return_FuncReturn_as_UnInteger32(cFS_Return_UnInteger32_clone(B, (cFS_Return_UnInteger32_table_t)u.value));
    case 3: return cFS_Return_FuncReturn_as_Integer16(cFS_Return_Integer16_clone(B, (cFS_Return_Integer16_table_t)u.value));
    case 4: return cFS_Return_FuncReturn_as_UnInteger16(cFS_Return_UnInteger16_clone(B, (cFS_Return_UnInteger16_table_t)u.value));
    case 5: return cFS_Return_FuncReturn_as_cFETime(cFETime_clone(B, (cFETime_table_t)u.value));
...
__flatbuffers_build_scalar_field(0, flatbuffers_, cFS_Return_UnInteger16_unInteger16, flatbuffers_uint16, uint16_t, 2, 2, UINT16_C(0), cFS_Return_UnInteger16)

static inline cFS_Return_UnInteger16_ref_t cFS_Return_UnInteger16_create(flatbuffers_builder_t *B __cFS_Return_UnInteger16_formal_args)
{
    if (cFS_Return_UnInteger16_start(B)
        || cFS_Return_UnInteger16_unInteger16_add(B, v0)) {
        return 0;
    }
    return cFS_Return_UnInteger16_end(B);
}
...
static cFS_Return_UnInteger16_ref_t cFS_Return_UnInteger16_clone(flatbuffers_builder_t *B, cFS_Return_UnInteger16_table_t t)
{
    __flatbuffers_memoize_begin(B, t);
    if (cFS_Return_UnInteger16_start(B)
        || cFS_Return_UnInteger16_unInteger16_pick(B, t)) {
        return 0;
    }
    __flatbuffers_memoize_end(B, t, cFS_Return_UnInteger16_end(B));
}
...
__flatbuffers_build_union_table_value_field(flatbuffers_, cFS_Return_ReturnData_retval, cFS_Return_FuncReturn, UnInteger16, cFS_Return_UnInteger16)
